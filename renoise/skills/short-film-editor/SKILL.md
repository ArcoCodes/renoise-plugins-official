...
description: >
  ...
  Use when user says "short film", "multi-clip", "story video", "1-minute video", "multi-segment video".
...
- **UI language**: Matches user's language (default: English). White theme, bold confident design.
